...
public class SRHomeBookDefItemVH extends ZYBaseViewHolder<SRBook> {
    ...
    private SRHomeBookItemVH.HomeBookItemListener listener;

    public SRHomeBookDefItemVH(SRHomeBookItemVH.HomeBookItemListener listener) {
