...
/**
 * Created by zhouhl on 2017/1/6.
 * 阴影layout
 */

public class ZYShadowLayout extends FrameLayout {
    ...
    public ZYShadowLayout(Context context) {
        super(context);
        initView(context, null);
    }

    public ZYShadowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public ZYShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
