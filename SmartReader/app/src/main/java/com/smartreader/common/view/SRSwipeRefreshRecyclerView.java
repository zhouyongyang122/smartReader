...
import com.smartreader.common.adapter.SRBaseRecyclerAdapter;
import com.smartreader.common.viewHolder.SRLoadMoreVH;

/**
 * Created by ZY on 17/3/16.
 */

public class SRSwipeRefreshRecyclerView extends RelativeLayout implements SRISwipeRecyclerView, SwipeRefreshLayout.OnRefreshListener {

    private SwipeRefreshLayout mSwipeRefreshLayout;
    private SRRefreshListener mRefreshListener;
    private RecyclerView mRecyclerView;
    private SRLoadMoreVH mMoreViewHolder;
    private SRILoadingView mLoadingView;
    private SRBaseRecyclerAdapter mAdapter;
    ...
    public SRSwipeRefreshRecyclerView(Context context) {
        super(context);
        init();
    }

    public SRSwipeRefreshRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SRSwipeRefreshRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mMoreViewHolder = new SRLoadMoreVH();
        mLoadingView = new SRLoadingView(getContext());
    ...
    @Override
    public void setRefreshListener(SRRefreshListener refreshListener) {
    ...
    @Override
    public void setLoadingView(@NonNull SRILoadingView loadingView) {
    ...
    @Override
    public SRILoadingView getLoadingView() {
        return mLoadingView;
    }

    @Override
    public void setAdapter(@NonNull SRBaseRecyclerAdapter adapter) {
        mAdapter = adapter;
    ...
    @Override
    public void setMoreViewHolder(@NonNull SRLoadMoreVH moreViewHolder) {
