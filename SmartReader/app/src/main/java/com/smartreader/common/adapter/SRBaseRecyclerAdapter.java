package com.smartreader.common.adapter;
...
import com.smartreader.common.viewHolder.SRBaseViewHolder;
...
public abstract class SRBaseRecyclerAdapter<D> extends RecyclerView.Adapter {
    ...
    private List<SRBaseViewHolder> mHeader = new ArrayList<>();
    private List<SRBaseViewHolder> mFooter = new ArrayList<>();

    private int mClickDelay = DEFAULT_DELAY;

    public SRBaseRecyclerAdapter() {

    }

    public SRBaseRecyclerAdapter(List<D> datas) {
        mDatas = datas;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        SRBaseViewHolder baseViewHolder;
        switch (viewType) {
            case TYPE_HEADER:
    ...
    public abstract SRBaseViewHolder<D> createViewHolder(int type);
    ...
    public void addHeader(SRBaseViewHolder baseViewHolder) {
        mHeader.add(baseViewHolder);
    }

    public void addFooter(SRBaseViewHolder baseViewHolder) {
        mFooter.add(baseViewHolder);
    }

    public void removeHeader(SRBaseViewHolder baseViewHolder) {
        mHeader.remove(baseViewHolder);
    }

    public void removeFooter(SRBaseViewHolder baseViewHolder) {
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public SRBaseViewHolder baseViewHolder;

        public ViewHolder(ViewGroup parent, SRBaseViewHolder baseViewHolder, View root) {
