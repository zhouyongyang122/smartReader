...
import com.smartreader.base.utils.ZYFileUtils;
import com.smartreader.base.utils.ZYUrlUtils;
...
public class ZYDownloadManager {
    ...
    private Set<ZYDownEntity> downEntities;
    ...
    public void startDown(final ZYDownEntity entity) {
        ...
        downloadService.download("bytes=" + entity.getCurrent() + "-", entity.getUrl())
                ...
                .map(new Func1<ResponseBody, ZYDownEntity>() {
                    @Override
                    public ZYDownEntity call(ResponseBody responseBody) {
                        try {
    ...
    public void stopDown(ZYDownEntity entity) {
        if (entity == null) {
            return;
        }
    ...
    public void pauseDown(ZYDownEntity entity) {
        if (entity == null) {
            return;
        }
    ...
    public void stopAllDown() {
        for (ZYDownEntity entity : downEntities) {
            stopDown(entity);
        }
    ...
    public void removeEntity(ZYDownEntity entity) {
