...
public class SRBookDao extends AbstractDao<SRBook, String> {
    ...
    public static class Properties {
        public final static Property Book_id = new Property(0, int.class, "book_id", false, "BOOK_ID");
        ...
        public final static Property Zip = new Property(5, String.class, "zip", true, "ZIP");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SRBOOK\" (" + //
                "\"BOOK_ID\" INTEGER NOT NULL ," + // 0: book_id
                "\"NAME\" TEXT," + // 1: name
                "\"GRADE_ID\" TEXT," + // 2: grade_id
                "\"PIC\" TEXT," + // 3: pic
                "\"GRADE\" TEXT," + // 4: grade
                "\"ZIP\" TEXT PRIMARY KEY NOT NULL ," + // 5: zip
    ...
    public SRBook readEntity(Cursor cursor, int offset) {
        SRBook entity = new SRBook( //
            cursor.getInt(offset + 0), // book_id
    ...
    public void readEntity(Cursor cursor, SRBook entity, int offset) {
        entity.setBook_id(cursor.getInt(offset + 0));
